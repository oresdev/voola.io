<template>
  <section id="terms">
    <nav>
      ...
      <router-link to="/contact-us" v-text="`Contact Us`" />
    </nav>

    <figure>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 59.83" width="100">
        <path
          fill="var(--scheme-v3)"
      ...
      <figcaption>
        <p>
          ...
          <a href="https://dmcc.secure.force.com/DocumentsVerification/?docId=004-0854291-270722" target="_blank"> licensee VOOLA DMCC 854291 registration number DMCC194133</a>
        </p>
